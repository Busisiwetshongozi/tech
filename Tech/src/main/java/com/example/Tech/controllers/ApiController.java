...
public class ApiController {
    ...
    public ResponseEntity<Object> verifyToken(@RequestHeader("Authorization") String authorizationHeader) {
        ...
        String idToken = authorizationHeader.substring(7);  // Extract token after "Bearer "
    ...
    // Custom method to fetch user details from your database
    private Map<String, Object> getUserInfoFromDatabase(String firebaseUid) {

        Map<String, Object> user = new HashMap<>();
        user.put("id", "your-db-id");
